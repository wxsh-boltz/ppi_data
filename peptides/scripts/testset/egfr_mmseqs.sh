e=0.1
TARGET_PATH="/data/rbg/users/wxsh/esm3/data/peptides/egfr_competition_2/egfr_competition_2_target_seqs.fasta"
BINDER_PATH="/data/rbg/users/wxsh/esm3/data/peptides/egfr_competition_2/egfr_competition_2_binder_seqs.fasta"
...
alignment_output_dir="/data/rbg/users/wxsh/esm3/data/peptides/egfr_competition_2/alnRes"
