...
target_align_path_mode_2 = "/data/rbg/users/wxsh/esm3/data/peptides/egfr_competition_2/alnRes/target_seqs_TO_rcsb_boltz2_train_seqs_cov_mode_2.m8"
target_align_path_mode_1 = "/data/rbg/users/wxsh/esm3/data/peptides/egfr_competition_2/alnRes/target_seqs_TO_rcsb_boltz2_train_seqs_cov_mode_1.m8"
binder_align_path = "/data/rbg/users/wxsh/esm3/data/peptides/egfr_competition_2/alnRes/binder_seqs_TO_rcsb_boltz2_train_seqs_cov_mode_1.m8"
binder_self_align_path = "/data/rbg/users/wxsh/esm3/data/peptides/egfr_competition_2/alnRes/binder_seqs_TO_binder_seqs.m8"
target_self_align_path = "/data/rbg/users/wxsh/esm3/data/peptides/egfr_competition_2/alnRes/target_seqs_TO_target_seqs.m8"
data_path = "/data/rbg/users/wxsh/esm3/data/peptides/egfr_competition_2/egfr_competition_2.json"
binder_sequence_similarity_threshold=1.0 #### 
saving_path = data_path.replace(".json", f".test_si_{binder_sequence_similarity_threshold}.json")

target_id2similar_rcsb_ids_mode_2 = read_alignment(target_align_path_mode_2, identity_threshold=0.7)
target_id2similar_rcsb_ids_mode_1 = read_alignment(target_align_path_mode_1, identity_threshold=0.7)
binder_id2similar_rcsb_ids = read_alignment(binder_align_path, identity_threshold=binder_sequence_similarity_threshold) # , mismatch_threshold=3
