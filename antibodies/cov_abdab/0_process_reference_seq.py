...
entry_path = "/data/rbg/users/wxsh/esm3/data/antibodies/cov_abdab/ref_seqs/spike_entry.json"
...
with open("/data/rbg/users/wxsh/esm3/data/antibodies/cov_abdab/ref_seqs/S_variants.fasta", "w") as fout:
