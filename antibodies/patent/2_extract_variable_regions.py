...
hchain_anarci = "heavy_sequences.anarci_H.csv"
# hchain_anarci_2 = "lchain_seqs.anarci_H.csv"
lchain_anarci = "light_sequences.anarci_KL.csv"
# lchain_anarci_2 = "hchain_seqs.anarci_KL.csv" # 
input_json_path = "vincent_data_clean.json"
...
print("Size of domain_datasets", len(domain_datasets))
print("edge_cases_cnt", edge_cases_cnt)

antigen_seq2id = dict()
for record in SeqIO.parse("antigen_sequences.fasta", "fasta"):
